    ...
    public class PhotonTransformView : MonoBehaviourPun, IPunObservable
    {
        ...
        public void Update()
        {
            ...
            if (!this.photonView.IsMine)
            {
                ...
                {
                    tr.localPosition = Vector3.MoveTowards(tr.localPosition, this.m_NetworkPosition, this.m_Distance  * Time.deltaTime * PhotonNetwork.SerializationRate *2 );
                    tr.localRotation = Quaternion.RotateTowards(tr.localRotation, this.m_NetworkRotation, this.m_Angle * Time.deltaTime * PhotonNetwork.SerializationRate * 2);
                }
                else
                // TESTOWAC
                {
